...
| Module | Summary |
| --- | --- |
| [crm_lead_template](crm_lead_template) |         Create lead notes from template. |
| [sale_crm_note](sale_crm_note) |          Copy lead noes to sale quote. |
| [sale_crm_ref](sale_crm_ref) |         Copy lead name to quote ref. |
