...
class SaleOrder(models.Model):
    ...
    def _skip_unpaid_close(self):
        return (
            ...
            .sudo()
            .get_param("sale_subscription_disable_unpaid_closing.skip_unpaid_subscription_close", "True")
            == "True"
        )
    ...
    def _skip_expired_close(self):
        return (
            self.env["ir.config_parameter"]
            .sudo()
            .get_param("sale_subscription_disable_unpaid_closing.skip_expired_subscription_close", "True")
            == "True"
        )
