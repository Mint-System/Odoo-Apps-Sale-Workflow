...
class ProductPricelist(models.Model):
    ...
    def _get_fixed_discount(self, product_id, product_uom_qty, date=None):
        ...
        rule_ids = self.item_ids.filtered(lambda r: 
            ...
            (r.applied_on == '1_product' and r.product_tmpl_id == product_id.product_tmpl_id)
        ...
        if rule_ids:
            ...
            rule_ids_with_min_qty = rule_ids.filtered(lambda l: l.min_quantity and (l.min_quantity <= product_uom_qty)).sorted(lambda r: r.min_quantity)
